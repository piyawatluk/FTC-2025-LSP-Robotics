...
public class MecanumDrive {
    ...
    public void drive(Gamepad gamepad) {
        double computedX_l = CoordinateConverter.computeX(gamepad.left_stick_x, gamepad1.left_stick_y, 1);
        double computedY_l = CoordinateConverter.computeY(gamepad.left_stick_y, gamepad1.left_stick_y, 1);
        double computedX_r = CoordinateConverter.computeX(gamepad.right_stick_x, gamepad1.right_stick_y, 1);
